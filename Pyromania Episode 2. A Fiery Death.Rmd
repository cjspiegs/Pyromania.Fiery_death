...
Fl model plot
```{r Fl model plots, results='hide', fig.show='hide', message =FALSE, collapse=TRUE}
...
Fl diff plot
```{r Fl diff plots, results='hide', fig.show='hide', message =FALSE, collapse=TRUE}
...
UVBIO model plot
```{r UVBIO model plots, collapse=TRUE, result='hide'}
...
```{r Sage and willow model plots combined}
