...
author: "CJ Spiegel et al. 2023, accepted at Global Change Biology"
date: "11/06/2023"
output:
  html_document:
    code_folding: hide
...
```{r fluorescence analysis and plots, results='hide', fig.show='hide', message =FALSE, collapse=TRUE}
library(mgcv)
library(tidymv)
######## T0 model
...
```{r Fl model plots compiled, results='hide', fig.show='hide', message =FALSE, collapse=TRUE}
